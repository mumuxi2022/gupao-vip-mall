...
public class ConfirmOrderResult {
    ...
    //用户收货地址列表
    private List<UserMemberReceiveAddress> memberReceiveAddressList;
    //用户可用优惠券列表
    private List<AdCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    private UserIntegrationConsumeSetting integrationConsumeSetting;
    //会员持有的积分
    ...
    public List<UserMemberReceiveAddress> getMemberReceiveAddressList() {
        return memberReceiveAddressList;
    }

    public void setMemberReceiveAddressList(List<UserMemberReceiveAddress> memberReceiveAddressList) {
        this.memberReceiveAddressList = memberReceiveAddressList;
    }

    public List<AdCouponHistoryDetail> getCouponHistoryDetailList() {
        return couponHistoryDetailList;
    }

    public void setCouponHistoryDetailList(List<AdCouponHistoryDetail> couponHistoryDetailList) {
        this.couponHistoryDetailList = couponHistoryDetailList;
    }

    public UserIntegrationConsumeSetting getIntegrationConsumeSetting() {
        return integrationConsumeSetting;
    }

    public void setIntegrationConsumeSetting(UserIntegrationConsumeSetting integrationConsumeSetting) {
