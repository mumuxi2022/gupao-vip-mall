package com.jt.mallsearch.service.impl;

import com.jt.feign.EsProductFeign;
import com.jt.mallsearch.repository.EsProductRepository;
import com.jt.mallsearch.service.EsProductService;
import com.jt.model.EsProduct;
import com.jt.model.EsProductRelatedInfo;
...
public class EsProductServiceImpl implements EsProductService {
    ...
    @Autowired
    private EsProductFeign productDao;
    @Autowired
    ...
    public int importAll() {
        List<EsProduct> esProductList = productDao.getAllEsProductList(-1L);
